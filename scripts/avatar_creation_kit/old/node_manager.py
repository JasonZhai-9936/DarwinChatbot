# node_manager.py - Simplified Node Manager for Avatar Creation Kit
import os
import json
...
class NodeManager:
    """Manages the node network and provides visualization"""
...
def create_node_manager_ui(node_manager: NodeManager):
    """Create the Node Manager UI with simplified interaction"""
    ...
    with ui.column().classes('w-full p-6 gap-4'):
        ...
        # Header
        ui.label('Node Manager').classes('text-3xl font-bold text-center mb-4')
